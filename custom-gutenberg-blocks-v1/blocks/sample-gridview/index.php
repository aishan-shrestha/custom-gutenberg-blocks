...
/**
 * Registers the `spl/block-sample-gridview` block on server.
 */
...
function register_block_gridlayout_postype() {
	...
	// Styles.
	wp_register_style(
		'spl-block-gridlayout-editor-style', // Handle.
		plugins_url( 'sample-gridview/assets/style.css', dirname( __FILE__ ) ),
	...
	register_block_type( 'spl/block-sample-gridview', array(
		'editor_script' => 'spl-block-gridlayout-postype-script',
		'style'         => 'spl-block-gridlayout-editor-style',
		'attributes'    => array(
								'postype' 	=> 	array(
													'type' => 'string',
												),
...
/**
 * Renders the 'spl/block-sample-gridview' block on server.
