...
== Description ==
	...
	- custom-gutenberg-blocks-v2: with using webpack & other packages; and is complied end result to "assets" folder on root path
	- Usages
...
== For Installation & Building Custom Block==
	...
	- Build Dev version: npm start ( UnMinify Version; this command will compiled CSS/JS into 'assets' folder on the root folder)


== For Deployment to Production ==
	- Build Production version:  npm run build ( CompiledMinify Version; this command will compiled CSS/JS into 'assets' folder on the root)
