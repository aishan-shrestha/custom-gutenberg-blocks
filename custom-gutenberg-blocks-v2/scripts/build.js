...
const fileBuildJS = path.resolve( theCWD, './assets/blocks.build.js' );
const fileEditorCSS = path.resolve( theCWD, './assets/blocks.editor.build.css' );
const fileStyleCSS = path.resolve( theCWD, './assets/blocks.style.build.css' );
